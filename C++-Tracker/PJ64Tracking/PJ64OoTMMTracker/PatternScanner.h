...
#define PATTERN_STATE_SIZE 32            // The size of the GamePatternState structure (bool Resolved + 3 padding + uint32_t PCs[8]). MUST match sizeof(GamePatternState), see the static_assert in PatternScanner.cpp.
