	...
	},
	{
		MM_CASTLE_IKANA,
		{
			MM_CASTLE_IKANA, (uint8_t)MMRegions::Ikana_Canyon,
			{
				...
				{ MM_IKANA_CASTLE_ROOF_KEG_ENTR, { UINT32_MAX, UINT32_MAX } },
				{ MM_IKANA_CASTLE_ROOF_BLOCK_ENTR, { UINT32_MAX, UINT32_MAX } },
			},
			NULL
		}
	},
	...
	},
	{
		MM_DEKU_PALACE,
		{
			MM_DEKU_PALACE, (uint8_t)MMRegions::Deku_Palace,
			{
				...
				{ MM_DEKU_PALACE_BRIDGE, { UINT32_MAX, UINT32_MAX } },
	...
	},
	{
		MM_GORON_VILLAGE,
		{
			MM_GORON_VILLAGE, (uint8_t)MMRegions::Goron_Village,
			{
				...
				{ MM_GORON_VILLAGE_SPRING_FROM_LONE_PEAK_SHRINE_ENTR, { UINT32_MAX, UINT32_MAX } },
	...
	},
	{
		MM_GREAT_BAY_COAST,
		{
			MM_GREAT_BAY_COAST, (uint8_t)MMRegions::Great_Bay_Coast,
			{
				...
				{ MM_VOID_GREAT_BAY_BEACH_ENTR, { UINT32_MAX, UINT32_MAX } },
				...
				{ MM_VOID_GREAT_BAY_LEDGE_BY_PINNACLE_ROCK_ENTR, { UINT32_MAX, UINT32_MAX } },
				...
				{ MM_COAST_FROM_MIKAU_TOMB_ENTR, { UINT32_MAX, UINT32_MAX } },
				{ MM_WARP_OWL_GREAT_BAY_ENTR, { UINT32_MAX, UINT32_MAX } },
				{ MM_GREAT_BAY_FROM_ENTRANCE_CAUGHT, { UINT32_MAX, UINT32_MAX } },
			},
			NULL
		}
	},
	...
	},
	{
		MM_IKANA_CANYON,
		{
			MM_IKANA_CANYON, (uint8_t)MMRegions::Ikana_Canyon,
			{
				...
				{ MM_IKANA_CANYON_WATERFALLS_ENTR, { UINT32_MAX, UINT32_MAX } },
				{ MM_WARP_BOSS_STONE_TOWER_INVERTED_ENTR, { UINT32_MAX, UINT32_MAX } },
			},
			NULL
		}
	},
	...
	},
	{
		MM_INSIDE_CASTLE_IKANA,
		{
			MM_INSIDE_CASTLE_IKANA, (uint8_t)MMRegions::Ikana_Canyon,
			{
				...
				{ MM_IKANA_CASTLE_FROM_BOSS_ENTR, { UINT32_MAX, UINT32_MAX } },
			},
			NULL
		}
	},
	...
	},
	{
		MM_MOON,
		{
			MM_MOON, (uint8_t)MMRegions::Moon,
			{
				...
				{ MM_MOON_TO_MOON_GORON_ENTR, { UINT32_MAX, UINT32_MAX } },
				{ MM_MOON_TO_MOON_ZORA_ENTR, { UINT32_MAX, UINT32_MAX } },
				{ MM_MOON_TO_MOON_LINK_ENTR, { UINT32_MAX, UINT32_MAX } },
				{ MM_MOON_TO_MAJORA_LAIR_ENTR, { UINT32_MAX, UINT32_MAX } },
			},
			NULL
		}
	},
	...
	},
	{
		MM_MOUNTAIN_VILLAGE,
		{
			MM_MOUNTAIN_VILLAGE, (uint8_t)MMRegions::Mountain_Village,
			{
				...
				{ MM_GROTTO_EXIT_GENERIC_MOUNTAIN_VILLAGE_SPRING, { UINT32_MAX, UINT32_MAX } },
				{ MM_MOUNTAIN_VILLAGE_SPRING_FROM_BLACKSMITH_ENTR, { UINT32_MAX, UINT32_MAX } },
				{ MM_MOUNTAIN_VILLAGE_SPRING_FROM_TWIN_ISLANDS_ENTR, { UINT32_MAX, UINT32_MAX } },
				{ MM_MOUNTAIN_VILLAGE_SPRING_FROM_GORON_GRAVEYARD_ENTR, { UINT32_MAX, UINT32_MAX } },
				{ MM_MOUNTAIN_VILLAGE_SPRING_FROM_SNOWHEAD_PATH_ENTR, { UINT32_MAX, UINT32_MAX } },
				{ MM_WARP_BOSS_MOUNTAIN_VILLAGE_SPRING_ENTR, { UINT32_MAX, UINT32_MAX } },
				{ MM_WARP_OWL_MOUNTAIN_VILLAGE_SPRING_ENTR, { UINT32_MAX, UINT32_MAX } },
				{ MM_TWIN_ISLANDS_SPRING_FROM_MOUNTAIN_VILLAGE_ENTR, { UINT32_MAX, UINT32_MAX } },
			},
			NULL
		}
	},
	...
	},
	{
		MM_OWLS,
		{
			MM_OWLS, (uint8_t)MMRegions::Songs,
			{
				...
				{ MM_OWL_STONE_TOWER_CHOICE, { UINT32_MAX, UINT32_MAX } },
				{ MM_OWL_GREAT_BAY_CHOICE, { UINT32_MAX, UINT32_MAX } },
				{ MM_OWL_ZORA_CAPE_CHOICE, { UINT32_MAX, UINT32_MAX } },
				{ MM_OWL_SNOWHEAD_CHOICE, { UINT32_MAX, UINT32_MAX } },
				{ MM_OWL_MOUNTAIN_VILLAGE_CHOICE, { UINT32_MAX, UINT32_MAX } },
				{ MM_OWL_CLOCK_TOWN_CHOICE, { UINT32_MAX, UINT32_MAX } },
				{ MM_OWL_MILK_ROAD_CHOICE, { UINT32_MAX, UINT32_MAX } },
				{ MM_OWL_WOODFALL_CHOICE, { UINT32_MAX, UINT32_MAX } },
			},
			NULL
		}
	},
	...
	},
	{
		MM_PINNACLE_ROCK,
		{
			MM_PINNACLE_ROCK, (uint8_t)MMRegions::Great_Bay_Coast,
			{
				...
				{ MM_VOID_PINNACLE_ROCK_MAIN_ENTR, { UINT32_MAX, UINT32_MAX } },
			},
			NULL
		}
	},
	{
		MM_PIRATE_FORTRESS_ENTRANCE,
		{
			MM_PIRATE_FORTRESS_ENTRANCE, (uint8_t)MMRegions::Great_Bay_Coast,
			{
				...
				{ MM_ENTRANCE_VENT_FROM_SEWERS_ENTR, { UINT32_MAX, UINT32_MAX } },
				{ MM_PIRATE_ENTRANCE_FROM_EXTERIOR_CAUGHT, { UINT32_MAX, UINT32_MAX } },
	...
	},
	{
		MM_PIRATE_FORTRESS_EXTERIOR,
		{
			MM_PIRATE_FORTRESS_EXTERIOR, (uint8_t)MMRegions::Great_Bay_Coast,
			{
				...
				{ MM_PIRATE_EXTERIOR_FROM_HOOKSHOT_LOOKOUT_ENTR, { UINT32_MAX, UINT32_MAX } },
				{ MM_PIRATE_EXTERIOR_FROM_TREASURE_ENTR, { UINT32_MAX, UINT32_MAX } },
				{ MM_PIRATE_EXTERIOR_FROM_TREASURE_EGG_ENTR, { UINT32_MAX, UINT32_MAX } },
				{ MM_PIRATE_EXTERIOR_FROM_CANON_ENTR, { UINT32_MAX, UINT32_MAX } },
				{ MM_PIRATE_EXTERIOR_FROM_CANON_EGG_ENTR, { UINT32_MAX, UINT32_MAX } },
				{ MM_PIRATE_EXTERIOR_FROM_BARREL_ENTR, { UINT32_MAX, UINT32_MAX } },
				{ MM_PIRATE_EXTERIOR_FROM_BARREL_EGG_ENTR, { UINT32_MAX, UINT32_MAX } },
				{ MM_PIRATE_FORTRESS_INTERIOR_FROM_LOOKOUT_ENTR, { UINT32_MAX, UINT32_MAX } },
				{ MM_PIRATE_EXTERIOR_CAUGHT, { UINT32_MAX, UINT32_MAX } },
			},
			NULL
		}
	},
	{
		MM_PIRATE_FORTRESS_INTERIOR,
		{
			MM_PIRATE_FORTRESS_INTERIOR, (uint8_t)MMRegions::Great_Bay_Coast,
			{
				...
				{ MM_PIRATE_INTERIOR_FROM_TREASURE_ENTR, { UINT32_MAX, UINT32_MAX } },
				{ MM_PIRATE_INTERIOR_FROM_TREASURE_EGG_ENTR, { UINT32_MAX, UINT32_MAX } },
				{ MM_PIRATE_INTERIOR_FROM_CANON_ENTR, { UINT32_MAX, UINT32_MAX } },
				{ MM_PIRATE_INTERIOR_FROM_CANON_EGG_ENTR, { UINT32_MAX, UINT32_MAX } },
				{ MM_PIRATE_INTERIOR_FROM_BARREL_ENTR, { UINT32_MAX, UINT32_MAX } },
				{ MM_PIRATE_INTERIOR_FROM_BARREL_EGG_ENTR, { UINT32_MAX, UINT32_MAX } },
				{ MM_SEWERS_FROM_EXTERIOR_GATE_ENTR, { UINT32_MAX, UINT32_MAX } },
				{ MM_SEWERS_FROM_EXTERIOR_DOOR_ENTR, { UINT32_MAX, UINT32_MAX } },
				{ MM_PIRATE_FORTRESS_ENTRANCE_FROM_SEWERS_VENT_ENTR, { UINT32_MAX, UINT32_MAX } },
			},
			NULL
		}
	},
	...
	},
	{
		MM_SOUTHERN_SWAMP,
		{
			MM_SOUTHERN_SWAMP, (uint8_t)MMRegions::Southern_Swamp_Road,
			{
				...
				{ MM_SWAMP_CLEARED_FROM_ROAD_ENTR, { UINT32_MAX, UINT32_MAX } },
				{ MM_SWAMP_CLEARED_FROM_TOURIST_INFORMATION_ENTR, { UINT32_MAX, UINT32_MAX } },
				{ MM_SWAMP_CLEARED_FROM_WOODFALL_ENTR, { UINT32_MAX, UINT32_MAX } },
				{ MM_SWAMP_CLEARED_FROM_PALACE_MAIN_ENTRANCE_ENTR, { UINT32_MAX, UINT32_MAX } },
				{ MM_SWAMP_CLEARED_FROM_PALACE_LEDGE_ENTR, { UINT32_MAX, UINT32_MAX } },
				{ MM_SWAMP_CLEARED_FROM_POTION_SHOP_ENTR, { UINT32_MAX, UINT32_MAX } },
				{ MM_KOUME_TARGET_FROM_TOURIST_ENTR, { UINT32_MAX, UINT32_MAX } },
				{ MM_SWAMP_CLEARED_FROM_MYSTERY_WOODS_ENTR, { UINT32_MAX, UINT32_MAX } },
				{ MM_SWAMP_CLEARED_FROM_SPIDER_HOUSE_ENTR, { UINT32_MAX, UINT32_MAX } },
				{ MM_SWAMP_CLEARED_FROM_IKANA_CANYON_ENTR, { UINT32_MAX, UINT32_MAX } },
				{ MM_WARP_OWL_SOUTHERN_SWAMP_CLEARED_ENTR, { UINT32_MAX, UINT32_MAX } },
			},
			NULL
		}
	},
	...
	},
	{
		MM_STONE_TOWER,
		{
			MM_STONE_TOWER, (uint8_t)MMRegions::Stone_Tower,
			{
				...
				{ MM_STONE_TOWER_FROM_STONE_TOWER_INVERTED_ENTR, { UINT32_MAX, UINT32_MAX } },
			},
			NULL
		}
	},
	...
	},
	{
		MM_TEMPLE_WOODFALL,
		{
			MM_TEMPLE_WOODFALL, (uint8_t)MMRegions::Woodfall,
			{
				...
				{ MM_DEKU_PRINCESS_ENTR, { UINT32_MAX, UINT32_MAX } },
				{ MM_WOODFALL_TEMPLE_TO_BOSS_ENTR, { UINT32_MAX, UINT32_MAX } },
			},
			NULL
		}
	},
	...
	},
	{
		MM_TOURIST_INFORMATION,
		{
			MM_TOURIST_INFORMATION, (uint8_t)MMRegions::Southern_Swamp,
			{
				...
				{ MM_KOUME_TARGET_ENTR, { UINT32_MAX, UINT32_MAX } },
			},
			NULL
		}
	},
	...
	},
	{
		MM_TWIN_ISLANDS,
		{
			MM_TWIN_ISLANDS, (uint8_t)MMRegions::Twin_Islands,
			{
				...
				{ MM_TWIN_ISLANDS_SPRING_FROM_GORON_VILLAGE_ENTR, { UINT32_MAX, UINT32_MAX } },
				{ MM_TWIN_ISLANDS_SPRING_FROM_GORON_RACETRACK_ENTR, { UINT32_MAX, UINT32_MAX } },
			},
			NULL
		}
	},
	{
		MM_WATERFALL_RAPIDS,
		{
			MM_WATERFALL_RAPIDS, (uint8_t)MMRegions::Zora_Cape,
			{
				...
				{ MM_START_RACE_BEAVERS_ENTR, { UINT32_MAX, UINT32_MAX } },
				{ MM_BEAVERS_RACE_FROM_END_RACE_ENTR, { UINT32_MAX, UINT32_MAX } },
				{ MM_END_RACE_BEAVERS_ENTR, { UINT32_MAX, UINT32_MAX } },
			},
			NULL
		}
	},
	{
		MM_WOODFALL,
		{
			MM_WOODFALL, (uint8_t)MMRegions::Woodfall,
			{
				...
				{ MM_WOODFALL_FROM_PRINCESS_ENTR, { UINT32_MAX, UINT32_MAX } },
	...
	},
	{
		MM_ZORA_CAPE,
		{
			MM_ZORA_CAPE, (uint8_t)MMRegions::Zora_Cape,
			{
				...
				{ MM_VOID_ZORA_CAPE_BEACH_ENTR, { UINT32_MAX, UINT32_MAX } },
