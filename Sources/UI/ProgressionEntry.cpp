...
const ProgEntry OoTQuestStatus[] =
{
    ...
    // Heart / Magic
    { EGameIcon::heart_container, "Heart Container", { OOT_HEART_CONTAINER, OOT_HEART_CONTAINER2, SHARED_HEART_CONTAINER }, true, 0, true },
    { EGameIcon::heart_piece, "Piece of Heart", { OOT_HEART_PIECE, OOT_TC_HEART_PIECE, SHARED_HEART_PIECE }, true, 0, true },
    ...
    // Songs
    { EGameIcon::song,        "Zelda's Lullaby",     { OOT_SONG_ZELDA, OOT_SONG_NOTE_ZELDA, SHARED_SONG_NOTE_ZELDA, SHARED_SONG_ZELDA },         true, 6 },
    { EGameIcon::song,        "Epona's Song",        { OOT_SONG_EPONA, OOT_SONG_NOTE_EPONA, SHARED_SONG_EPONA, SHARED_SONG_NOTE_EPONA },           true, 6 },
    ...
    { EGameIcon::song_purple, "Nocturne of Shadow",  { OOT_SONG_TP_SHADOW, OOT_SONG_NOTE_TP_SHADOW, SHARED_SONG_NOTE_TP_SHADOW, SHARED_SONG_TP_SHADOW },        true, 7 },
    { EGameIcon::song_orange, "Requiem of Spirit",   { OOT_SONG_TP_SPIRIT, OOT_SONG_NOTE_TP_SPIRIT, SHARED_SONG_NOTE_TP_SPIRIT, SHARED_SONG_TP_SPIRIT },         true, 6 },
    { EGameIcon::song_yellow, "Prelude of Light",    { OOT_SONG_TP_LIGHT, OOT_SONG_NOTE_TP_LIGHT, SHARED_SONG_NOTE_TP_LIGHT, SHARED_SONG_TP_LIGHT },         true, 6 },
    { EGameIcon::song,        "Elegy of Emptiness",  { OOT_SONG_EMPTINESS, OOT_SONG_NOTE_EMPTINESS, SHARED_SONG_EMPTINESS, SHARED_SONG_NOTE_EMPTINESS },  true, 7 },
    { EGameIcon::song,        "Song of Healing",     { OOT_SONG_HEALING, OOT_SONG_NOTE_HEALING, SHARED_SONG_NOTE_HEALING, SHARED_SONG_HEALING }, true, 6 },
    { EGameIcon::song,        "Song of Soaring",     { OOT_SONG_SOARING, OOT_SONG_NOTE_SOARING, SHARED_SONG_NOTE_SOARING, SHARED_SONG_SOARING }, true, 6 },
    { EGameIcon::song_green,  "Sonata of Awakening", { OOT_SONG_AWAKENING, OOT_SONG_NOTE_AWAKENING, SHARED_SONG_NOTE_AWAKENING, SHARED_SONG_AWAKENING },          true, 7 },
    { EGameIcon::song_red,    "Goron Lullaby",       { OOT_SONG_GORON_HALF, OOT_SONG_GORON, OOT_SONG_NOTE_GORON, SHARED_SONG_NOTE_GORON, SHARED_SONG_GORON, SHARED_SONG_GORON_HALF },   true, 8 },
    { EGameIcon::song_blue,   "New Wave Bossa Nova", { OOT_SONG_ZORA, OOT_SONG_NOTE_ZORA, SHARED_SONG_NOTE_ZORA, SHARED_SONG_ZORA },      true, 7 },
    { EGameIcon::song_purple, "Oath to Order",       { OOT_SONG_ORDER, OOT_SONG_NOTE_ORDER, SHARED_SONG_NOTE_ORDER, SHARED_SONG_ORDER },   true, 6 },
    ...
    { EGameIcon::triforce_piece, "Triforce Piece",       { OOT_TRIFORCE, OOT_TRIFORCE_FULL, SHARED_TRIFORCE }, true, 0, true },
...
const ProgEntry OoTDungeonsItems[] =
{
    ...
    { EGameIcon::small_key,      "Small Key (Forest Temple)",            { OOT_SMALL_KEY_FOREST }, true, 0, true },
    { EGameIcon::small_key,      "Small Key (Fire Temple)",            { OOT_SMALL_KEY_FIRE }, true, 0, true },
    { EGameIcon::small_key,      "Small Key (Water Temple)",            { OOT_SMALL_KEY_WATER }, true, 0, true },
    { EGameIcon::small_key,      "Small Key (Shadow Temple)",            { OOT_SMALL_KEY_SHADOW }, true, 0, true },
    { EGameIcon::small_key,      "Small Key (Spirit Temple)",            { OOT_SMALL_KEY_SPIRIT }, true, 0, true },
    { EGameIcon::small_key,      "Small Key (Bottom of the Well)",            { OOT_SMALL_KEY_BOTW }, true, 0, true },
    { EGameIcon::small_key,      "Small Key (Gerudo's Training Ground)",            { OOT_SMALL_KEY_GTG }, true, 0, true },
    { EGameIcon::small_key,      "Small Key (Gerudo's Fortress)",            { OOT_SMALL_KEY_GF }, true, 0, true },
    { EGameIcon::small_key,      "Small Key (Ganon's Castle)",            { OOT_SMALL_KEY_GANON }, true, 0, true },
    { EGameIcon::small_key,      "Small Key (Chest Game)",            { OOT_SMALL_KEY_TCG }, true, 0, true },
    ...
    { EGameIcon::rusty_key, "Rusty Key (Market Treasure Chest Game)",	{ OOT_RUSTY_KEY_TREASURE_CHEST_GAME }, false },
    { EGameIcon::rusty_key, "Rusty Key (Guard House)",	{ OOT_RUSTY_KEY_GUARD_HOUSE }, false },
    { EGameIcon::rusty_key, "Rusty Key (Hyrule Castle Gatehouse)",	{ OOT_RUSTY_KEY_HYRULE_CASTLE }, false },
    { EGameIcon::rusty_key, "Rusty Key (Dog Lady House)",	{ OOT_RUSTY_KEY_DOG_LADY_HOUSE }, false },
    { EGameIcon::rusty_key, "Rusty Key (Back Alley House)",	{ OOT_RUSTY_KEY_BACK_ALLEY_HOUSE }, false },
    { EGameIcon::rusty_key, "Rusty Key (Bombchu Shop)",	{ OOT_RUSTY_KEY_BOMBCHU_SHOP }, false },
    { EGameIcon::rusty_key, "Rusty Key (Mask Shop)",	{ OOT_RUSTY_KEY_MASK_SHOP }, false },
    { EGameIcon::rusty_key, "Rusty Key (Market Bazaar)",	{ OOT_RUSTY_KEY_CHILD_BAZAAR }, false },
    { EGameIcon::rusty_key, "Rusty Key (Market Potion Shop)",	{ OOT_RUSTY_KEY_CHILD_POTION_SHOP }, false },
    { EGameIcon::rusty_key, "Rusty Key (Market Shooting Gallery)",	{ OOT_RUSTY_KEY_CHILD_SHOOTING_GALLERY }, false },
    { EGameIcon::rusty_key, "Rusty Key (Bombchu Bowling)",	{ OOT_RUSTY_KEY_BOMBCHU_BOWLING }, false },
    { EGameIcon::rusty_key, "Rusty Key (Lakeside Laboratory)",	{ OOT_RUSTY_KEY_LABORATORY }, false },
    { EGameIcon::rusty_key, "Rusty Key (Fishing Pond)",	{ OOT_RUSTY_KEY_FISHING_POND }, false },
    { EGameIcon::rusty_key, "Rusty Key (Lon Lon Silo)",	{ OOT_RUSTY_KEY_SILO }, false },
    { EGameIcon::rusty_key, "Rusty Key (Lon Lon Ranch Stable)",	{ OOT_RUSTY_KEY_RANCH_STABLE }, false },
    { EGameIcon::rusty_key, "Rusty Key (Lon Lon Ranch House)",	{ OOT_RUSTY_KEY_RANCH_HOUSE }, false },
    { EGameIcon::rusty_key, "Rusty Key (Malon's Room)",	{ OOT_RUSTY_KEY_RANCH_HOUSE_ROOM }, false },
    { EGameIcon::rusty_key, "Rusty Key (Kakariko Graveyard Hut)",	{ OOT_RUSTY_KEY_GRAVEYARD }, false },
    { EGameIcon::rusty_key, "Rusty Key (Windmill)",	{ OOT_RUSTY_KEY_WINDMILL }, false },
    { EGameIcon::rusty_key, "Rusty Key (Impa's House)",	{ OOT_RUSTY_KEY_IMPA_HOUSE }, false },
    { EGameIcon::rusty_key, "Rusty Key (Carpenter House)",	{ OOT_RUSTY_KEY_CARPENTER_HOUSE }, false },
    { EGameIcon::rusty_key, "Rusty Key (Granny Potion Shop)",	{ OOT_RUSTY_KEY_GRANNY_POTION_SHOP }, false },
    { EGameIcon::rusty_key, "Rusty Key (Kakariko Shooting Gallery)",	{ OOT_RUSTY_KEY_ADULT_SHOOTING_GALLERY }, false },
    { EGameIcon::rusty_key, "Rusty Key (House of Skulltula)",	{ OOT_RUSTY_KEY_SKULLTULA_HOUSE }, false },
    { EGameIcon::rusty_key, "Rusty Key (Kakariko Bazaar)",	{ OOT_RUSTY_KEY_ADULT_BAZAAR }, false },
    { EGameIcon::rusty_key, "Rusty Key (Kakariko Potion Shop)",	{ OOT_RUSTY_KEY_ADULT_POTION_SHOP }, false },
    { EGameIcon::rusty_key, "Rusty Key (Kakariko Potion Shop Back)",	{ OOT_RUSTY_KEY_ADULT_POTION_SHOP_BACK }, false },

    // Silver rupees / Silver pouches
    { EGameIcon::sr, "Silver Rupee (Dodongo's Cavern)", { OOT_RUPEE_SILVER_DC }, true, 0, true },
    { EGameIcon::sr, "Silver Rupee (Shadow Temple - Invisible Blades)", { OOT_RUPEE_SILVER_SHADOW_BLADES }, true, 0, true },
    { EGameIcon::sr, "Silver Rupee (Shadow Temple - Large Pits)", { OOT_RUPEE_SILVER_SHADOW_PIT }, true, 0, true },
    { EGameIcon::sr, "Silver Rupee (Shadow Temple - Scythe)", { OOT_RUPEE_SILVER_SHADOW_SCYTHE }, true, 0, true },
    { EGameIcon::sr, "Silver Rupee (Shadow Temple - Spikes)", { OOT_RUPEE_SILVER_SHADOW_SPIKES }, true, 0, true },
    { EGameIcon::sr, "Silver Rupee (Spirit Temple - Adult)", { OOT_RUPEE_SILVER_SPIRIT_ADULT }, true, 0, true },
    { EGameIcon::sr, "Silver Rupee (Spirit Temple - Boulders)", { OOT_RUPEE_SILVER_SPIRIT_BOULDERS }, true, 0, true },
    { EGameIcon::sr, "Silver Rupee (Spirit Temple - Child)", { OOT_RUPEE_SILVER_SPIRIT_CHILD }, true, 0, true },
    { EGameIcon::sr, "Silver Rupee (Spirit Temple - Lobby)", { OOT_RUPEE_SILVER_SPIRIT_LOBBY }, true, 0, true },
    { EGameIcon::sr, "Silver Rupee (Spirit Temple - Sun Block)", { OOT_RUPEE_SILVER_SPIRIT_SUN }, true, 0, true },
    { EGameIcon::sr, "Silver Rupee (Ice Cavern - Block)", { OOT_RUPEE_SILVER_IC_BLOCK }, true, 0, true },
    { EGameIcon::sr, "Silver Rupee (Ice Cavern - Scythe)", { OOT_RUPEE_SILVER_IC_SCYTHE }, true, 0, true },
    { EGameIcon::sr, "Silver Rupee (Bottom of the Well)", { OOT_RUPEE_SILVER_BOTW }, true, 0, true },
    { EGameIcon::sr, "Silver Rupee (Gerudo Training Ground - Lava)", { OOT_RUPEE_SILVER_GTG_LAVA }, true, 0, true },
    { EGameIcon::sr, "Silver Rupee (Gerudo Training Ground - Slopes)", { OOT_RUPEE_SILVER_GTG_SLOPES }, true, 0, true },
    { EGameIcon::sr, "Silver Rupee (Gerudo Training Ground - Water)", { OOT_RUPEE_SILVER_GTG_WATER }, true, 0, true },
    { EGameIcon::sr, "Silver Rupee (Ganon's Castle - Forest Trial)", { OOT_RUPEE_SILVER_GANON_FOREST }, true, 0, true },
    { EGameIcon::sr, "Silver Rupee (Ganon's Castle - Fire Trial)", { OOT_RUPEE_SILVER_GANON_FIRE }, true, 0, true },
    { EGameIcon::sr, "Silver Rupee (Ganon's Castle - Light Trial)", { OOT_RUPEE_SILVER_GANON_LIGHT }, true, 0, true },
    { EGameIcon::sr, "Silver Rupee (Ganon's Castle - Water Trial)", { OOT_RUPEE_SILVER_GANON_WATER }, true, 0, true },
    { EGameIcon::sr, "Silver Rupee (Ganon's Castle - Shadow Trial)", { OOT_RUPEE_SILVER_GANON_SHADOW }, true, 0, true },
    { EGameIcon::sr, "Silver Rupee (Ganon's Castle - Spirit Trial)", { OOT_RUPEE_SILVER_GANON_SPIRIT }, true, 0, true },
...
const ProgEntry OoTEquipments[] =
{
    ...
    { EGameIcon::biggest_seed, "Large Bullet Bag", { OOT_BULLET_BAG2, SHARED_BULLET_BAG2 }, false },
    { EGameIcon::biggest_seed, "Largest Bullet Bag", { OOT_BULLET_BAG3, SHARED_BULLET_BAG3 }, false },
    { EGameIcon::big_quiver,         "Big Quiver",       { OOT_QUIVER2, SHARED_QUIVER2 },       false },
    { EGameIcon::biggest_quiver,     "Biggest Quiver",   { OOT_QUIVER3, SHARED_QUIVER3 },   false },
    { EGameIcon::bomb_bag,           "Bomb Bag",         { OOT_BOMB_BAG, SHARED_BOMB_BAG },         false },
    { EGameIcon::big_bomb,           "Big Bomb Bag",     { OOT_BOMB_BAG, OOT_BOMB_BAG2, SHARED_BOMB_BAG },         false },
    { EGameIcon::biggest_bomb,       "Biggest Bomb Bag", { OOT_BOMB_BAG, OOT_BOMB_BAG3, SHARED_BOMB_BAG },     false },
    ...
    { EGameIcon::nut_upgrade_2, "Second Deku Nut Upgrade", { OOT_NUT_UPGRADE, OOT_NUT_UPGRADE2, SHARED_NUT_UPGRADE }, false },
    { EGameIcon::stick_upgrade_1, "Deku Stick Upgrade", { OOT_STICK_UPGRADE, SHARED_STICK_UPGRADE }, false },
    { EGameIcon::stick_upgrade_2, "Second Deku Stick Upgrade", { OOT_STICK_UPGRADE, OOT_STICK_UPGRADE2, SHARED_STICK_UPGRADE }, false },

    // Wallets
    { EGameIcon::child_wallet, "Child's Wallet", { OOT_WALLET, OOT_PROG_WALLET, SHARED_WALLET }, false },
    { EGameIcon::wallet, "Adult's Wallet", { OOT_WALLET2, OOT_PROG_WALLET, SHARED_WALLET }, false },
    { EGameIcon::big_wallet, "Giant's Wallet", { OOT_WALLET3, OOT_PROG_WALLET, SHARED_WALLET }, false },
    { EGameIcon::colossal_wallet, "Colossal Wallet", { OOT_WALLET4, OOT_PROG_WALLET, SHARED_WALLET }, false },
    { EGameIcon::bottomless_wallet, "Bottomless Wallet", { OOT_WALLET5, OOT_PROG_WALLET, SHARED_WALLET }, false },
...
const ProgEntry OoTMajorItems[] =
{
    ...
    { EGameIcon::slingshot,     "Fairy Slingshot",      { OOT_SLINGSHOT, SHARED_SLINGSHOT },        false },
    ...
    { EGameIcon::skull, "Skull Mask", { OOT_MASK_SKULL, SHARED_MASK_SKULL }, false },
    { EGameIcon::spooky, "Spooky Mask", { OOT_MASK_SPOOKY, SHARED_MASK_SPOOKY }, false },
    { EGameIcon::gerudo, "Gerudo Mask", { OOT_MASK_GERUDO, SHARED_MASK_GERUDO }, false },
...
const ProgEntry MMQuestStatus[] =
{
    ...
    // Hearts / Magic
    { EGameIcon::heart_piece, "Piece of Heart", { MM_HEART_PIECE, SHARED_HEART_PIECE }, true, 0, true },
    { EGameIcon::heart_container, "Heart Container", { MM_HEART_CONTAINER, SHARED_HEART_CONTAINER }, true, 0, true },
    ...
    // Songs
    { EGameIcon::song,        "Song of Time",        { MM_SONG_TIME, MM_SONG_NOTE_TIME, SHARED_SONG_TIME, SHARED_SONG_NOTE_TIME },    true, 6 },
    ...
    { EGameIcon::song_blue,   "New Wave Bossa Nova", { MM_SONG_ZORA, MM_SONG_NOTE_ZORA, SHARED_SONG_NOTE_ZORA, SHARED_SONG_ZORA },      true, 7 },
    { EGameIcon::song_orange, "Elegy of Emptiness",  { MM_SONG_EMPTINESS, MM_SONG_NOTE_EMPTINESS, SHARED_SONG_EMPTINESS, SHARED_SONG_NOTE_EMPTINESS },           true, 7 },
    { EGameIcon::song_purple, "Oath to Order",       { MM_SONG_ORDER, MM_SONG_NOTE_ORDER, SHARED_SONG_NOTE_ORDER, SHARED_SONG_ORDER },   true, 6 },
    { EGameIcon::song,        "Zelda's Lullaby",     { MM_SONG_ZELDA, MM_SONG_NOTE_ZELDA, SHARED_SONG_NOTE_ZELDA, SHARED_SONG_ZELDA },         true, 6 },
    { EGameIcon::song,        "Saria's Song",        { MM_SONG_SARIA, MM_SONG_NOTE_SARIA, SHARED_SONG_NOTE_SARIA, SHARED_SONG_SARIA },           true, 6 },
    { EGameIcon::song_green,  "Minuet of Forest",    { MM_SONG_TP_FOREST, MM_SONG_NOTE_TP_FOREST, SHARED_SONG_NOTE_TP_FOREST, SHARED_SONG_TP_FOREST },          true, 6 },
    { EGameIcon::song_red,    "Bolero of Fire",      { MM_SONG_TP_FIRE, MM_SONG_NOTE_TP_FIRE, SHARED_SONG_NOTE_TP_FIRE, SHARED_SONG_TP_FIRE },          true, 8 },
    { EGameIcon::song_blue,   "Serenade of Water",   { MM_SONG_TP_WATER, MM_SONG_NOTE_TP_WATER, SHARED_SONG_NOTE_TP_WATER, SHARED_SONG_TP_WATER },        true, 5 },
    { EGameIcon::song_purple, "Nocturne of Shadow",  { MM_SONG_TP_SHADOW, MM_SONG_NOTE_TP_SHADOW, SHARED_SONG_NOTE_TP_SHADOW, SHARED_SONG_TP_SHADOW },        true, 7 },
    { EGameIcon::song_orange, "Requiem of Spirit",   { MM_SONG_TP_SPIRIT, MM_SONG_NOTE_TP_SPIRIT, SHARED_SONG_NOTE_TP_SPIRIT, SHARED_SONG_TP_SPIRIT },         true, 6 },
    { EGameIcon::song_yellow, "Prelude of Light",    { MM_SONG_TP_LIGHT, MM_SONG_NOTE_TP_LIGHT, SHARED_SONG_NOTE_TP_LIGHT, SHARED_SONG_TP_LIGHT },         true, 6 },
...
const ProgEntry MMDungeonsItems[] =
{
    ...
    // Small keys / Key ring
    { EGameIcon::small_key, "Small Key (Woodfall Temple)", { MM_SMALL_KEY_WF, MM_SMALL_KEY }, true, 0, true },
    { EGameIcon::small_key, "Small Key (Snowhead Temple)", { MM_SMALL_KEY_SH, MM_SMALL_KEY }, true, 0, true },
    { EGameIcon::small_key, "Small Key (Great Bay Temple)", { MM_SMALL_KEY_GB, MM_SMALL_KEY }, true, 0, true },
    { EGameIcon::small_key, "Small Key (Stone Tower Temple)", { MM_SMALL_KEY_ST, MM_SMALL_KEY }, true, 0, true },
    ...
    { EGameIcon::rusty_key, "Rusty Key (Tourist Information)",	{ MM_RUSTY_KEY_TOURIST_INFORMATION }, false },
    { EGameIcon::rusty_key, "Rusty Key (Kotake's Potion Shop)",	{ MM_RUSTY_KEY_POTION_SHOP }, false },
    { EGameIcon::rusty_key, "Rusty Key (Post Office)",	{ MM_RUSTY_KEY_POST_OFFICE }, false },
    { EGameIcon::rusty_key, "Rusty Key (Swordsman's School)",	{ MM_RUSTY_KEY_SWORDSMAN_SCHOOL }, false },
    { EGameIcon::rusty_key, "Rusty Key (Lottery)",	{ MM_RUSTY_KEY_LOTTERY }, false },
    { EGameIcon::rusty_key, "Rusty Key (Bomb Shop)",	{ MM_RUSTY_KEY_BOMB_SHOP }, false },
    { EGameIcon::rusty_key, "Rusty Key (Trading Post)",	{ MM_RUSTY_KEY_TRADING_POST }, false },
    { EGameIcon::rusty_key, "Rusty Key (Curiosity Shop)",	{ MM_RUSTY_KEY_CURIOSITY_SHOP }, false },
    { EGameIcon::rusty_key, "Rusty Key (Kafei's Hideout)",	{ MM_RUSTY_KEY_KAFEI_HIDEOUT }, false },
    { EGameIcon::rusty_key, "Rusty Key (Clock Town Shooting Gallery)",	{ MM_RUSTY_KEY_TOWN_ARCHERY }, false },
    { EGameIcon::rusty_key, "Rusty Key (Swamp Shooting Gallery)",	{ MM_RUSTY_KEY_SWAMP_ARCHERY }, false },
    { EGameIcon::rusty_key, "Rusty Key (Astral Observatory)",	{ MM_RUSTY_KEY_OBSERVATORY }, false },
    { EGameIcon::rusty_key, "Rusty Key (Mountain Smithy)",	{ MM_RUSTY_KEY_BLACKSMITH }, false },
    { EGameIcon::rusty_key, "Rusty Key (Music Box House)",	{ MM_RUSTY_KEY_MUSIC_HOUSE }, false },
    { EGameIcon::rusty_key, "Rusty Key (Marine Research Lab)",	{ MM_RUSTY_KEY_LABORATORY }, false },
    { EGameIcon::rusty_key, "Rusty Key (Beneath the Graveyard)",	{ MM_RUSTY_KEY_BENEATH_GRAVEYARD }, false },
    { EGameIcon::rusty_key, "Rusty Key (Dampe's House)",	{ MM_RUSTY_KEY_DAMPE_HOUSE }, false },
    { EGameIcon::rusty_key, "Rusty Key (Mayor's Residence)",	{ MM_RUSTY_KEY_MAYOR_RESIDENCE }, false },
    { EGameIcon::rusty_key, "Rusty Key (Mayor's Residence Office)",	{ MM_RUSTY_KEY_MAYOR_RESIDENCE_OFFICE }, false },
    { EGameIcon::rusty_key, "Rusty Key (Mayor's Residence Salon)",	{ MM_RUSTY_KEY_MAYOR_RESIDENCE_SALON }, false },
    { EGameIcon::rusty_key, "Rusty Key (Mayor's Residence Bedroom)",	{ MM_RUSTY_KEY_MAYOR_RESIDENCE_KAFEI }, false },
    { EGameIcon::rusty_key, "Rusty Key (Clock Town Chest Game)",	{ MM_RUSTY_KEY_TREASURE_CHEST_GAME }, false },
    { EGameIcon::rusty_key, "Rusty Key (Honey & Darling)",	{ MM_RUSTY_KEY_HONEY_DARLING }, false },
    { EGameIcon::rusty_key, "Rusty Key (Milk Bar)",	{ MM_RUSTY_KEY_MILK_BAR }, false },
    { EGameIcon::rusty_key, "Rusty Key (Doggy Racetrack)",	{ MM_RUSTY_KEY_DOG_RACETRACK }, false },
    { EGameIcon::rusty_key, "Rusty Key (Cucco Shack)",	{ MM_RUSTY_KEY_CUCCO_SHACK }, false },
    { EGameIcon::rusty_key, "Rusty Key (Romani Ranch House)",	{ MM_RUSTY_KEY_RANCH_HOUSE }, false },
    { EGameIcon::rusty_key, "Rusty Key (Romani Ranch Barn)",	{ MM_RUSTY_KEY_RANCH_BARN }, false },
    { EGameIcon::rusty_key, "Rusty Key (Romani Ranch Bedroom)",	{ MM_RUSTY_KEY_RANCH_HOUSE_ROOM }, false },
    { EGameIcon::rusty_key, "Rusty Key (Zora Shop)",	{ MM_RUSTY_KEY_ZORA_SHOP }, false },
    { EGameIcon::rusty_key, "Rusty Key (Japas' Room)",	{ MM_RUSTY_KEY_ZORA_JAPAS_ROOM }, false },
    { EGameIcon::rusty_key, "Rusty Key (Tijo's Room)",	{ MM_RUSTY_KEY_ZORA_TIJO_ROOM }, false },
    { EGameIcon::rusty_key, "Rusty Key (Lulu's Room)",	{ MM_RUSTY_KEY_ZORA_LULU_ROOM }, false },
    { EGameIcon::rusty_key, "Rusty Key (Evan's Room)",	{ MM_RUSTY_KEY_ZORA_EVAN_ROOM }, false },
    { EGameIcon::rusty_key, "Rusty Key (Stock Pot Inn)",	{ MM_RUSTY_KEY_STOCK_POT_INN }, false },
    { EGameIcon::rusty_key, "Rusty Key (Stock Pot Inn Roof)",	{ MM_RUSTY_KEY_STOCK_POT_INN_ROOF }, false },
    { EGameIcon::rusty_key, "Rusty Key (Grandma's Room)",	{ MM_RUSTY_KEY_GRANDMA_ROOM }, false },
    { EGameIcon::rusty_key, "Rusty Key (Stock Pot Inn Staff Room)",	{ MM_RUSTY_KEY_STOCK_POT_INN_STAFF_ROOM }, false },
    { EGameIcon::rusty_key, "Rusty Key (Stock Pot Inn Dormitory)",	{ MM_RUSTY_KEY_STOCK_POT_INN_DORMITORY }, false },

    // Stray Fairy
    { EGameIcon::sf,              "Stray Fairy (Woodfall)",      { MM_STRAY_FAIRY_WF, MM_STRAY_FAIRY }, true, 0, true },
    { EGameIcon::sf_green,        "Stray Fairy (Snowhead)",      { MM_STRAY_FAIRY_SH, MM_STRAY_FAIRY }, true, 0, true },
    { EGameIcon::sf_blue,         "Stray Fairy (Great Bay)",     { MM_STRAY_FAIRY_GB, MM_STRAY_FAIRY }, true, 0, true },
    { EGameIcon::sf_yellow,       "Stray Fairy (Stone Tower)",   { MM_STRAY_FAIRY_ST, MM_STRAY_FAIRY }, true, 0, true },
    ...
    // Skulltulas
    { EGameIcon::swamp_token,     "Swamp Skulltula Token",       { MM_GS_TOKEN_SWAMP }, true, 0, true },
    { EGameIcon::ocean_token,     "Ocean Skulltula Token",       { MM_GS_TOKEN_OCEAN }, true, 0, true },
...
const ProgEntry MMEquipments[] =
{
    ...
    // Quivers / Bags
    { EGameIcon::biggest_seed, "Large Bullet Bag", { MM_BULLET_BAG2, SHARED_BULLET_BAG2 }, false },
    { EGameIcon::biggest_seed, "Largest Bullet Bag", { MM_BULLET_BAG3, SHARED_BULLET_BAG3 }, false },
    { EGameIcon::big_quiver, "Big Quiver", { MM_QUIVER2, SHARED_QUIVER2 }, false },
    { EGameIcon::biggest_quiver, "Biggest Quiver", { MM_QUIVER3, SHARED_QUIVER3 }, false },
    { EGameIcon::bomb_bag, "Bomb Bag", { MM_BOMB_BAG, SHARED_BOMB_BAG }, false },
    { EGameIcon::big_bomb, "Big Bomb Bag", { MM_BOMB_BAG, MM_BOMB_BAG2, SHARED_BOMB_BAG }, false },
    { EGameIcon::biggest_bomb, "Biggest Bomb Bag", { MM_BOMB_BAG, MM_BOMB_BAG3, SHARED_BOMB_BAG }, false },
    ...
    { EGameIcon::bombchu_bag, "Big Bombchu Bag", { MM_BOMBCHU_BAG, MM_BOMBCHU_BAG2, SHARED_BOMBCHU_BAG }, false },
    { EGameIcon::bombchu_bag, "Biggest Bombchu Bag", { MM_BOMBCHU_BAG, MM_BOMBCHU_BAG3, SHARED_BOMBCHU_BAG }, false },

    // Others
    { EGameIcon::bombers, "Bombers' Notebook", { MM_BOMBER_NOTEBOOK }, false },
    { EGameIcon::child_wallet, "Child Wallet", { MM_WALLET, MM_PROG_WALLET, SHARED_WALLET }, false },
    { EGameIcon::wallet, "Adult Wallet", { MM_WALLET2, MM_PROG_WALLET, SHARED_WALLET }, false },
    { EGameIcon::big_wallet, "Giant Wallet", { MM_WALLET3, MM_PROG_WALLET, SHARED_WALLET }, false },
    { EGameIcon::colossal_wallet, "Colossal Wallet", { MM_WALLET4, MM_PROG_WALLET, SHARED_WALLET }, false },
    ...
    { EGameIcon::nut_upgrade_2, "Second Deku Nut Upgrade", { MM_NUT_UPGRADE, MM_NUT_UPGRADE2, SHARED_NUT_UPGRADE }, false },
    { EGameIcon::stick_upgrade_1, "Deku Stick Upgrade", { MM_STICK_UPGRADE, SHARED_STICK_UPGRADE }, false },
    { EGameIcon::stick_upgrade_2, "Second Deku Stick Upgrade", { MM_STICK_UPGRADE, MM_STICK_UPGRADE2, SHARED_STICK_UPGRADE }, false },
...
const ProgEntry MMMajorItems[] =
{
    ...
    { EGameIcon::slingshot,     "Fairy Slingshot",      { MM_SLINGSHOT, SHARED_SLINGSHOT },        false },
...
const ProgEntry SoulsMMNPCs[] =
{
    ...
    { EGameIcon::soul_of_npc, "Soul of Toto", { MM_SOUL_NPC_TOTO }, false },
...
{
    { EGameIcon::stick, "Deku Stick", { OOT_STICK, OOT_STICKS_5, OOT_STICKS_10, SHARED_STICK, SHARED_STICKS_5, SHARED_STICKS_10 }, true, 0, true },
    { EGameIcon::nut, "Deku Nuts", { OOT_NUTS_5, OOT_NUTS_5_ALT, OOT_NUTS_10, SHARED_NUT, SHARED_NUTS_5, SHARED_NUTS_10 }, true, 0, true },
    { EGameIcon::bomb, "Bombs", { OOT_BOMB, OOT_BOMBS_5, OOT_BOMBS_10, OOT_BOMBS_20, OOT_BOMBS_30, SHARED_BOMB, SHARED_BOMBS_5, SHARED_BOMBS_10, SHARED_BOMBS_20, SHARED_BOMBS_30 }, true, 0, true },
    { EGameIcon::bombchu,       "Bombchus",              { OOT_BOMBCHU_5, OOT_BOMBCHU_10, OOT_BOMBCHU_20, SHARED_BOMBCHU, SHARED_BOMBCHU_5, SHARED_BOMBCHU_10, SHARED_BOMBCHU_20 }, true, 0, true },
    { EGameIcon::seeds, "Deku Seeds", { OOT_DEKU_SEEDS_5, OOT_DEKU_SEEDS_30, SHARED_DEKU_SEEDS_5, SHARED_DEKU_SEEDS_30 }, true, 0, true },
    { EGameIcon::arrow, "Arrows", { OOT_ARROWS_5, OOT_ARROWS_10, OOT_ARROWS_30, SHARED_ARROWS_5, SHARED_ARROWS_10, SHARED_ARROWS_30, SHARED_ARROWS_40 }, true, 0, true },
    { EGameIcon::heart, "Recovery Heart", { OOT_RECOVERY_HEART, SHARED_RECOVERY_HEART }, true, 0, true },
    { EGameIcon::magic, "Small Magic Jar", { OOT_MAGIC_JAR_SMALL, SHARED_MAGIC_JAR_SMALL }, true, 0, true },
    { EGameIcon::double_magic, "Large Magic Jar", { OOT_MAGIC_JAR_LARGE, SHARED_MAGIC_JAR_LARGE }, true, 0, true },
    { EGameIcon::carp_fish, "Child Fish", { OOT_FISHING_POND_CHILD_FISH_2LBS, OOT_FISHING_POND_CHILD_FISH_3LBS, OOT_FISHING_POND_CHILD_FISH_4LBS, OOT_FISHING_POND_CHILD_FISH_5LBS, OOT_FISHING_POND_CHILD_FISH_6LBS, OOT_FISHING_POND_CHILD_FISH_7LBS, OOT_FISHING_POND_CHILD_FISH_8LBS, OOT_FISHING_POND_CHILD_FISH_9LBS, OOT_FISHING_POND_CHILD_FISH_10LBS, OOT_FISHING_POND_CHILD_FISH_11LBS, OOT_FISHING_POND_CHILD_FISH_12LBS, OOT_FISHING_POND_CHILD_FISH_13LBS, OOT_FISHING_POND_CHILD_FISH_14LBS }, true, 0, true },
    { EGameIcon::carp_fish, "Child Loach", { OOT_FISHING_POND_CHILD_LOACH_14LBS, OOT_FISHING_POND_CHILD_LOACH_15LBS, OOT_FISHING_POND_CHILD_LOACH_16LBS, OOT_FISHING_POND_CHILD_LOACH_17LBS, OOT_FISHING_POND_CHILD_LOACH_18LBS, OOT_FISHING_POND_CHILD_LOACH_19LBS }, true, 0, true },
    ...
    { EGameIcon::fairy, "Big Fairy", { OOT_FAIRY_BIG, MM_FAIRY_BIG, SHARED_FAIRY_BIG }, true, 0, true },
};

const ProgEntry MMItems[] =
{
    { EGameIcon::stick, "Deku Sticks", { MM_STICK, MM_UNK_2F, MM_UNK_30, MM_UNK_31, SHARED_STICK, SHARED_STICKS_5, SHARED_STICKS_10 }, true, 0, true },
    { EGameIcon::nut, "Nuts", { MM_NUT, MM_NUTS_5, MM_NUTS_10, MM_UNK_2B, MM_UNK_2C, MM_UNK_2D, SHARED_NUT, SHARED_NUTS_5, SHARED_NUTS_10 }, true, 0, true },
    { EGameIcon::bomb, "Bombs", { MM_BOMB, MM_BOMBS_5, MM_BOMBS_10, MM_BOMBS_20, MM_BOMBS_30, SHARED_BOMB, SHARED_BOMBS_5, SHARED_BOMBS_10, SHARED_BOMBS_20, SHARED_BOMBS_30 }, true, 0, true },
    { EGameIcon::bombchu, "Bombchus", { MM_BOMBCHU, MM_BOMBCHU_5, MM_BOMBCHU_10, MM_BOMBCHU_20, SHARED_BOMBCHU, SHARED_BOMBCHU_5, SHARED_BOMBCHU_10, SHARED_BOMBCHU_20 }, true, 0, true },
    { EGameIcon::seeds, "Deku Seeds", { MM_DEKU_SEEDS_5, MM_DEKU_SEEDS_30, SHARED_DEKU_SEEDS_5, SHARED_DEKU_SEEDS_30 }, true, 0, true },
    { EGameIcon::arrow,   "Arrows", { MM_ARROWS_10, MM_ARROWS_30, MM_ARROWS_40, MM_UNK_21, SHARED_ARROWS_5, SHARED_ARROWS_10, SHARED_ARROWS_30, SHARED_ARROWS_40 }, true, 0, true },
    { EGameIcon::heart, "Recovery Heart", { MM_RECOVERY_HEART, SHARED_RECOVERY_HEART }, true, 0, true },
    { EGameIcon::magic, "Small Magic Jar", { MM_MAGIC_JAR_SMALL, SHARED_MAGIC_JAR_SMALL }, true, 0, true },
    { EGameIcon::double_magic, "Large Magic Jar", { MM_MAGIC_JAR_LARGE, SHARED_MAGIC_JAR_LARGE }, true, 0, true },

};

const ProgEntry Bottles[] =
{
    { EGameIcon::red_potion, "Red Potion", { OOT_POTION_RED, OOT_BOTTLE_POTION_RED, MM_POTION_RED, MM_BOTTLE_POTION_RED, SHARED_POTION_RED, SHARED_BOTTLE_POTION_RED }, true, 0, true },
    { EGameIcon::green_potion, "Green Potion", { OOT_POTION_GREEN, OOT_BOTTLE_POTION_GREEN, MM_POTION_GREEN, MM_BOTTLE_POTION_GREEN, SHARED_POTION_GREEN, SHARED_BOTTLE_POTION_GREEN }, true, 0, true },
    { EGameIcon::blue_potion, "Blue Potion", { OOT_POTION_BLUE, OOT_BOTTLE_POTION_BLUE, MM_POTION_BLUE, MM_BOTTLE_POTION_BLUE, SHARED_POTION_BLUE, SHARED_BOTTLE_POTION_BLUE }, true, 0, true },
    { EGameIcon::milk, "Milk", { OOT_MILK, OOT_BOTTLE_MILK, MM_MILK, MM_BOTTLE_MILK, SHARED_MILK, SHARED_BOTTLE_MILK }, true, 0, true },
    { EGameIcon::chateau, "Chateau Romani", { MM_CHATEAU, MM_BOTTLE_CHATEAU, OOT_CHATEAU, OOT_BOTTLE_CHATEAU, SHARED_CHATEAU, SHARED_BOTTLE_CHATEAU }, true, 0, true },
    { EGameIcon::blue_fire, "Blue Fire", { OOT_BLUE_FIRE, OOT_BOTTLE_BLUE_FIRE, MM_BLUE_FIRE, MM_BOTTLE_BLUE_FIRE, SHARED_BLUE_FIRE, SHARED_BOTTLE_BLUE_FIRE }, true, 0, true },
    { EGameIcon::bottled_poe, "Poe", { OOT_POE, OOT_BOTTLE_POE, MM_POE, MM_BOTTLE_POE, SHARED_POE, SHARED_BOTTLE_POE }, true, 0, true },
    { EGameIcon::bottled_big_poe, "Big Poe", { OOT_BIG_POE, OOT_BOTTLE_BIG_POE, MM_BIG_POE, MM_BOTTLE_BIG_POE, SHARED_BIG_POE, SHARED_BOTTLE_BIG_POE }, true, 0, true },
    { EGameIcon::bottled_fairy, "Fairy", { OOT_FAIRY, OOT_BOTTLE_FAIRY, MM_FAIRY, MM_BOTTLE_FAIRY, SHARED_FAIRY, SHARED_BOTTLE_FAIRY }, true, 0, true },
    { EGameIcon::bottled_bugs, "Bugs", { OOT_BUGS, MM_BUGS, SHARED_BUGS }, true, 0, true },
    { EGameIcon::bottled_fish, "Fish", { OOT_FISH, MM_FISH, SHARED_FISH }, true, 0, true },
    { EGameIcon::dust, "Gold Dust", { MM_GOLD_DUST, MM_BOTTLED_GOLD_DUST, OOT_GOLD_DUST, OOT_BOTTLED_GOLD_DUST, SHARED_BOTTLED_GOLD_DUST }, true, 0, true },
};

const ProgEntry Rupees[] =
{
    { EGameIcon::green_coin, "Coin (Green)", { OOT_COIN_GREEN }, true, 0, true },
    { EGameIcon::red_coin, "Coin (Red)", { OOT_COIN_RED }, true, 0, true },
    { EGameIcon::blue_coin, "Coin (Blue)", { OOT_COIN_BLUE }, true, 0, true },
    { EGameIcon::yellow_coin, "Coin (Yellow)", { OOT_COIN_YELLOW }, true, 0, true },
    { EGameIcon::rupee,          "Green Rupee",          { OOT_RUPEE_GREEN, MM_RUPEE_GREEN, SHARED_RUPEE_GREEN }, true, 0, true },
    { EGameIcon::blue_rupee,     "Blue Rupee",           { OOT_RUPEE_BLUE, OOT_TC_RUPEE_BLUE, MM_RUPEE_BLUE, SHARED_RUPEE_BLUE }, true, 0, true },
    { EGameIcon::red_rupee,      "Red Rupee",            { OOT_RUPEE_RED, OOT_TC_RUPEE_RED, MM_RUPEE_RED, MM_RUPEE_RED_10, SHARED_RUPEE_RED }, true, 0, true },
    { EGameIcon::purple_rupee,   "Purple Rupee",         { OOT_RUPEE_PURPLE, OOT_TC_RUPEE_PURPLE, MM_RUPEE_PURPLE, SHARED_RUPEE_PURPLE }, true, 0, true },
    { EGameIcon::sr,             "Silver Rupee",         { MM_RUPEE_SILVER, SHARED_RUPEE_SILVER }, true, 0, true },
    { EGameIcon::gold_rupee,     "Huge Rupee",           { OOT_RUPEE_HUGE, MM_RUPEE_GOLD, SHARED_RUPEE_GOLD }, true, 0, true },
    { EGameIcon::rainbow_rupee,  "Rainbow Rupee",        { OOT_RUPEE_RAINBOW, SHARED_RUPEE_RAINBOW }, true, 0, true },
};

const ProgEntry Traps[] =
{
    { EGameIcon::fire_trap, "Fire Trap", { OOT_TRAP_FIRE }, true, 0, true },
    { EGameIcon::ice_trap, "Ice Trap", { OOT_TRAP_ICE, OOT_UNUSED_ICE_TRAP }, true, 0, true },
    { EGameIcon::shock_trap, "Shock Trap", { OOT_TRAP_SHOCK }, true, 0, true },
    { EGameIcon::knockback_trap, "Knockback Trap", { OOT_TRAP_KNOCKBACK }, true, 0, true },
    { EGameIcon::magic_trap, "Anti-Magic Trap", { OOT_TRAP_ANTI_MAGIC }, true, 0, true },
    { EGameIcon::drain_trap, "Drain Trap", { OOT_TRAP_DRAIN }, true, 0, true },
    { EGameIcon::rupoor, "Rupoor", { OOT_TRAP_RUPOOR }, true, 0, true },
    { EGameIcon::nothing, "Nothing", { NOTHING }, true, 0, true },
};
