...
const ProgEntry OoTQuestStatus[] =
{
    ...
    // Songs
    { EGameIcon::song,        "Zelda's Lullaby",     { OOT_SONG_ZELDA },         true },
    { EGameIcon::song,        "Epona's Song",        { OOT_SONG_EPONA, OOT_SONG_NOTE_EPONA, SHARED_SONG_EPONA, SHARED_SONG_NOTE_EPONA },           true },
    { EGameIcon::song,        "Saria's Song",        { OOT_SONG_SARIA, OOT_SONG_NOTE_SARIA },           true },
    ...
    { EGameIcon::song_green,  "Minuet of Forest",    { OOT_SONG_TP_FOREST, OOT_SONG_NOTE_TP_FOREST },          true },
    { EGameIcon::song_red,    "Bolero of Fire",      { OOT_SONG_TP_FIRE, OOT_SONG_NOTE_TP_FIRE },          true },
    { EGameIcon::song_blue,   "Serenade of Water",   { OOT_SONG_TP_WATER, OOT_SONG_NOTE_TP_FIRE },        true },
    { EGameIcon::song_purple, "Nocturne of Shadow",  { OOT_SONG_TP_SHADOW, OOT_SONG_NOTE_TP_FIRE },        true },
    { EGameIcon::song_orange, "Requiem of Spirit",   { OOT_SONG_TP_SPIRIT, OOT_SONG_NOTE_TP_FIRE },         true },
    { EGameIcon::song_yellow, "Prelude of Light",    { OOT_SONG_TP_LIGHT, OOT_SONG_NOTE_TP_FIRE },         true },
...
const ProgEntry MMQuestStatus[] =
{
    ...
    { EGameIcon::song,        "Song of Healing",     { MM_SONG_HEALING, MM_SONG_NOTE_HEALING }, true },
    { EGameIcon::song,        "Epona's Song",        { MM_SONG_EPONA, MM_SONG_NOTE_EPONA, SHARED_SONG_EPONA, SHARED_SONG_NOTE_EPONA },           true },
    { EGameIcon::song,        "Song of Soaring",     { MM_SONG_SOARING, MM_SONG_NOTE_SOARING }, true },
    ...
    { EGameIcon::song_green,  "Sonata of Awakening", { MM_SONG_AWAKENING, MM_SONG_NOTE_AWAKENING },          true },
    { EGameIcon::song_red,    "Goron Lullaby",       { MM_SONG_GORON_HALF, MM_SONG_GORON, MM_SONG_NOTE_GORON },   true },
