...
const ProgEntry OoTDungeonsItems[] =
{
    ...
    { EGameIcon::rusty_key, "Rusty Key (Treasure Chest Game)",	{ OOT_RUSTY_KEY_TREASURE_CHEST_GAME }, false },
    { EGameIcon::rusty_key, "Rusty Key (Guard House)",	{ OOT_RUSTY_KEY_GUARD_HOUSE }, false },
    { EGameIcon::rusty_key, "Rusty Key (Hyrule Castle)",	{ OOT_RUSTY_KEY_HYRULE_CASTLE }, false },
    ...
    { EGameIcon::rusty_key, "Rusty Key (Child Bazaar)",	{ OOT_RUSTY_KEY_CHILD_BAZAAR }, false },
    { EGameIcon::rusty_key, "Rusty Key (Child Potion Shop)",	{ OOT_RUSTY_KEY_CHILD_POTION_SHOP }, false },
    { EGameIcon::rusty_key, "Rusty Key (Child Shooting Gallery)",	{ OOT_RUSTY_KEY_CHILD_SHOOTING_GALLERY }, false },
    { EGameIcon::rusty_key, "Rusty Key (Bombchu Bowling)",	{ OOT_RUSTY_KEY_BOMBCHU_BOWLING }, false },
    { EGameIcon::rusty_key, "Rusty Key (Laboratory)",	{ OOT_RUSTY_KEY_LABORATORY }, false },
    { EGameIcon::rusty_key, "Rusty Key (Fishing Pond)",	{ OOT_RUSTY_KEY_FISHING_POND }, false },
    { EGameIcon::rusty_key, "Rusty Key (Silo)",	{ OOT_RUSTY_KEY_SILO }, false },
    { EGameIcon::rusty_key, "Rusty Key (Ranch Stable)",	{ OOT_RUSTY_KEY_RANCH_STABLE }, false },
    { EGameIcon::rusty_key, "Rusty Key (Ranch House)",	{ OOT_RUSTY_KEY_RANCH_HOUSE }, false },
    ...
    { EGameIcon::rusty_key, "Rusty Key (Adult Shooting Gallery)",	{ OOT_RUSTY_KEY_ADULT_SHOOTING_GALLERY }, false },
    { EGameIcon::rusty_key, "Rusty Key (Skulltula House)",	{ OOT_RUSTY_KEY_SKULLTULA_HOUSE }, false },
    { EGameIcon::rusty_key, "Rusty Key (Adult Bazaar)",	{ OOT_RUSTY_KEY_ADULT_BAZAAR }, false },
    { EGameIcon::rusty_key, "Rusty Key (Adult Potion Shop)",	{ OOT_RUSTY_KEY_ADULT_POTION_SHOP }, false },
    { EGameIcon::rusty_key, "Rusty Key (Adult Potion Shop Back)",	{ OOT_RUSTY_KEY_ADULT_POTION_SHOP_BACK }, false },
...
const ProgEntry MMDungeonsItems[] =
{
    ...
    { EGameIcon::rusty_key, "Rusty Key (Potion Shop)",	{ MM_RUSTY_KEY_POTION_SHOP }, false },
    { EGameIcon::rusty_key, "Rusty Key (Post Office)",	{ MM_RUSTY_KEY_POST_OFFICE }, false },
    { EGameIcon::rusty_key, "Rusty Key (Swordsman School)",	{ MM_RUSTY_KEY_SWORDSMAN_SCHOOL }, false },
    ...
    { EGameIcon::rusty_key, "Rusty Key (Town Archery)",	{ MM_RUSTY_KEY_TOWN_ARCHERY }, false },
    { EGameIcon::rusty_key, "Rusty Key (Swamp Archery)",	{ MM_RUSTY_KEY_SWAMP_ARCHERY }, false },
    { EGameIcon::rusty_key, "Rusty Key (Observatory)",	{ MM_RUSTY_KEY_OBSERVATORY }, false },
    { EGameIcon::rusty_key, "Rusty Key (Blacksmith)",	{ MM_RUSTY_KEY_BLACKSMITH }, false },
    { EGameIcon::rusty_key, "Rusty Key (Music House)",	{ MM_RUSTY_KEY_MUSIC_HOUSE }, false },
    { EGameIcon::rusty_key, "Rusty Key (Oceanic Laboratory)",	{ MM_RUSTY_KEY_LABORATORY }, false },
    ...
    { EGameIcon::rusty_key, "Rusty Key (Kafei's Room)",	{ MM_RUSTY_KEY_MAYOR_RESIDENCE_KAFEI }, false },
    { EGameIcon::rusty_key, "Rusty Key (Treasure Game)",	{ MM_RUSTY_KEY_TREASURE_CHEST_GAME }, false },
    ...
    { EGameIcon::rusty_key, "Rusty Key (Romani's Room)",	{ MM_RUSTY_KEY_RANCH_HOUSE_ROOM }, false },
