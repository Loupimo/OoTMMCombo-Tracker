...
{
    { "Deku Tree", "", "./Resources/OoT/Dungeons/Deku_Tree/Deku_Tree_Map.png", (uint8_t)OoTRegions::Dungeons, false, GameLayout::oot },
    { "Dodongo's Cavern", "", "./Resources/OoT/Dungeons/Cavern/Cavern_Map.png", (uint8_t)OoTRegions::Dungeons, false, GameLayout::oot },
    { "Inside Jabu-Jabu", "", "./Resources/OoT/Dungeons/Jabu-Jabu/Jabu-Jabu_Map.png", (uint8_t)OoTRegions::Dungeons, false, GameLayout::oot },
    { "Forest Temple", "", "./Resources/OoT/Dungeons/Forest/Forest_Map.png", (uint8_t)OoTRegions::Dungeons, false, GameLayout::oot },
    { "Fire Temple", "", "./Resources/OoT/Dungeons/Fire/Fire_Map.png", (uint8_t)OoTRegions::Dungeons, false, GameLayout::oot },
    { "Water Temple", "", "./Resources/OoT/Dungeons/Water/Water_Map.png", (uint8_t)OoTRegions::Dungeons, false, GameLayout::oot },
    { "Spirit Temple", "", "./Resources/OoT/Dungeons/Spirit/Spirit_Map.png", (uint8_t)OoTRegions::Dungeons, false, GameLayout::oot },
    { "Shadow Temple", "", "./Resources/OoT/Dungeons/Shadow/Shadow_Map.png", (uint8_t)OoTRegions::Dungeons, false, GameLayout::oot },
    { "Bottom of the Well", "", "./Resources/OoT/Dungeons/Well/Well_Map.png", (uint8_t)OoTRegions::Dungeons, false, GameLayout::oot },
    { "Ice Cavern", "./Resources/OoT/Dungeons/Ice/Ice.jpg", "./Resources/OoT/Dungeons/Ice/Ice_Map.png", (uint8_t)OoTRegions::Dungeons, false, GameLayout::oot },
    { "Ganon Tower", "", "./Resources/OoT/Ganon/GT_Map.jpg", (uint8_t)OoTRegions::Dungeons, false, GameLayout::oot },
    { "Gerudo Training Ground", "./Resources/OoT/Dungeons/GTG/GTG.jpg", "./Resources/OoT/Dungeons/GTG/GTG.png", (uint8_t)OoTRegions::Gerudo_Fortress, false, GameLayout::oot },
    { "Thieves' Hideout", "./Resources/OoT/Gerudo_Fortress/Hideout.png", "./Resources/OoT/Gerudo_Fortress/Hideout_Map.png", (uint8_t)OoTRegions::Gerudo_Fortress, false, GameLayout::oot },
    { "Inside Ganon Castle", "./Resources/OoT/Ganon/GT_1F.jpg", "./Resources/OoT/Ganon/GT_1F_Map.png", (uint8_t)OoTRegions::Dungeons, false, GameLayout::oot },
    ...
    { "Treasure Shop", "./Resources/OoT/Market/Treasure_Game.png", "./Resources/OoT/Market/Treasure_Game_Map.png", (uint8_t)OoTRegions::Market, false, GameLayout::oot },
    { "Gohma's Lair", "", "./Resources/OoT/Dungeons/Deku_Tree/Gohma_Map.png", (uint8_t)OoTRegions::None, false, GameLayout::oot },
    { "King Dodongo's Lair", "", "./Resources/OoT/Dungeons/Cavern/King_Map.png", (uint8_t)OoTRegions::None, false, GameLayout::oot },
    { "Barinade's Lair", "", "./Resources/OoT/Dungeons/Jabu-Jabu/Barinade_Map.png", (uint8_t)OoTRegions::None, false, GameLayout::oot },
    { "Phantom Ganon's Lair", "", "./Resources/OoT/Dungeons/Forest/Phantom_Map.png", (uint8_t)OoTRegions::None, false, GameLayout::oot },
    { "Volvagia's Lair", "", "./Resources/OoT/Dungeons/Fire/Volvagia_Map.png", (uint8_t)OoTRegions::None, false, GameLayout::oot },
    { "Morpha's Lair", "", "./Resources/OoT/Dungeons/Water/Morpha_Map.png", (uint8_t)OoTRegions::None, false, GameLayout::oot },
    { "Twinrova's Lair", "", "./Resources/OoT/Dungeons/Spirit/Twinrova_Map.png", (uint8_t)OoTRegions::None, false, GameLayout::oot },
    { "Bongo-Bongo's Lair", "", "./Resources/OoT/Dungeons/Shadow/Bongo_Map.png", (uint8_t)OoTRegions::None, false, GameLayout::oot },
    { "Ganondorf's Lair", "", "./Resources/OoT/Ganon/Ganondorf_Map.png", (uint8_t)OoTRegions::None, false, GameLayout::oot },
    ...
    { "Know-It-All Brothers's House", "./Resources/OoT/Kokiri_Forest/Know_It_All.png", "./Resources/OoT/Kokiri_Forest/Know_It_All_Map.png", (uint8_t)OoTRegions::Kokiri_Forest, false, GameLayout::oot },
    { "Twins's House", "./Resources/OoT/Kokiri_Forest/Twins_House.png", "./Resources/OoT/Kokiri_Forest/Twins_House_Map.png", (uint8_t)OoTRegions::Kokiri_Forest, false, GameLayout::oot },
    { "Mido's House", "./Resources/OoT/Kokiri_Forest/Mido_House.png", "./Resources/OoT/Kokiri_Forest/Mido_House_Map.png", (uint8_t)OoTRegions::Kokiri_Forest, false, GameLayout::oot },
    { "Saria's House", "./Resources/OoT/Kokiri_Forest/Saria_House.png", "./Resources/OoT/Kokiri_Forest/Saria_House_Map.png", (uint8_t)OoTRegions::Kokiri_Forest, false, GameLayout::oot },
    { "Carpenters Boss's House", "", "./Resources/OoT/Kakariko/Carpenter_House_Map.png", (uint8_t)OoTRegions::None, false, GameLayout::oot },
    { "Back Alley's House", "./Resources/OoT/Market/Back_Alley_House.png", "./Resources/OoT/Market/Back_Alley_House_Map.png", (uint8_t)OoTRegions::Market, false, GameLayout::oot },
    { "Bazaar", "", "", (uint8_t)OoTRegions::None, false, GameLayout::oot },
    { "Kokiri Shop", "./Resources/OoT/Kokiri_Forest/Shop.png", "./Resources/OoT/Kokiri_Forest/Shop_Map.png", (uint8_t)OoTRegions::Kokiri_Forest, false, GameLayout::oot },
    { "Goron Shop", "./Resources/OoT/Goron_City/Shop.png", "./Resources/OoT/Goron_City/Shop_Map.png", (uint8_t)OoTRegions::Goron_City, false, GameLayout::oot },
    { "Zora Shop", "./Resources/OoT/Zora_Domain/Shop.png", "./Resources/OoT/Zora_Domain/Shop_Map.png", (uint8_t)OoTRegions::Zora_Domain, false, GameLayout::oot },
    { "Kakariko Potion Shop", "./Resources/OoT/Kakariko/Potion_Shop.png", "./Resources/OoT/Kakariko/Potion_Shop_Map.png", (uint8_t)OoTRegions::Kakariko, false, GameLayout::oot },
    { "Market Potion Shop", "./Resources/OoT/Market/Potion_Shop.png", "./Resources/OoT/Market/Potion_Shop_Map.png", (uint8_t)OoTRegions::Market, false, GameLayout::oot },
    { "Bombchu Shop", "./Resources/OoT/Market/Bombchu_Shop.png", "./Resources/OoT/Market/Bombchu_Shop_Map.png", (uint8_t)OoTRegions::Market, false, GameLayout::oot },
    { "Happy Mask Shop", "", "", (uint8_t)OoTRegions::None, false, GameLayout::oot },
    { "Link's House", "./Resources/OoT/Kokiri_Forest/Link_House.png", "./Resources/OoT/Kokiri_Forest/Link_House_Map.png", (uint8_t)OoTRegions::Kokiri_Forest, true, GameLayout::oot },
    { "Dog Lady's House", "./Resources/OoT/Market/Dog_Lady_House.png", "./Resources/OoT/Market/Dog_Lady_House_Map.png", (uint8_t)OoTRegions::Market, false, GameLayout::oot },
    { "Stable", "./Resources/OoT/Ranch/Stable.png", "./Resources/OoT/Ranch/Stable_Map.png", (uint8_t)OoTRegions::Lon_Lon_Ranch, false, GameLayout::oot },
    { "Impa's House", "./Resources/OoT/Kakariko/Impa_House.png", "./Resources/OoT/Kakariko/Impa_House_Map.png", (uint8_t)OoTRegions::Kakariko, false, GameLayout::oot },
    { "Laboratory", "./Resources/OoT/Lake_Hylia/Laboratory.png", "./Resources/OoT/Lake_Hylia/Laboratory_Map.png", (uint8_t)OoTRegions::Lake_Hylia, false, GameLayout::oot },
    { "Carpenter's Tent", "", "./Resources/OoT/Gerudo_Valley/Carpenter_Tent_Map.png", (uint8_t)OoTRegions::None, false, GameLayout::oot },
    { "Dampe's House", "", "./Resources/OoT/Graveyard/Dampe_House_Map.png", (uint8_t)OoTRegions::None, false, GameLayout::oot },
    ...
    { "Redead's Tomb", "./Resources/OoT/Graveyard/Redead_Tomb.png", "./Resources/OoT/Graveyard/Redead_Tomb_Map.png", (uint8_t)OoTRegions::Graveyard, false, GameLayout::oot },
    { "Fairy's Fountain Tomb", "./Resources/OoT/Graveyard/Fairy_Fountain_Tomb.png", "./Resources/OoT/Graveyard/Fairy_Fountain_Tomb_Map.png", (uint8_t)OoTRegions::Graveyard, false, GameLayout::oot },
    { "Royal's Family Tomb", "./Resources/OoT/Graveyard/Royal_Tomb.png", "./Resources/OoT/Graveyard/Royal_Tomb_Map.png", (uint8_t)OoTRegions::Graveyard, false, GameLayout::oot },
    { "Shooting Gallery", "", "", (uint8_t)OoTRegions::None, false, GameLayout::oot },
    { "Temple of Time", "./Resources/OoT/Market/Temple_of_Time.png", "./Resources/OoT/Market/Temple_of_Time_Map.png", (uint8_t)OoTRegions::Market, false, GameLayout::oot },
    ...
    { "Dampe's Tomb", "./Resources/OoT/Graveyard/Dampe_Tomb.png", "./Resources/OoT/Graveyard/Dampe_Tomb_Map.png", (uint8_t)OoTRegions::Graveyard, false, GameLayout::oot },
    { "Fishing Pond", "./Resources/OoT/Lake_Hylia/Pond.png", "./Resources/OoT/Lake_Hylia/Pond_Map.png", (uint8_t)OoTRegions::Lake_Hylia, true, GameLayout::oot },
    { "Castle Courtyard", "./Resources/OoT/Hyrule/Castle_Courtyard.png", "./Resources/OoT/Hyrule/Castle_Courtyard_Map.png", (uint8_t)OoTRegions::Castle, false, GameLayout::oot },
    { "Bombchu Bowling", "./Resources/OoT/Market/Bombchu_Bowling.png", "./Resources/OoT/Market/Bombchu_Bowling_Map.png", (uint8_t)OoTRegions::Market, false, GameLayout::oot },
    { "Talon's House", "./Resources/OoT/Ranch/Ranch_House_Silo.png", "./Resources/OoT/Ranch/Ranch_House_Silo_Map.png", (uint8_t)OoTRegions::Lon_Lon_Ranch, true, GameLayout::oot },
    { "Pot's House", "./Resources/OoT/Market/Pot_House.png", "./Resources/OoT/Market/Pot_House_Map.png", (uint8_t)OoTRegions::Market, true, GameLayout::oot },
    { "Granny Potion Shop", "./Resources/OoT/Kakariko/Granny_Potion_Shop.png", "./Resources/OoT/Kakariko/Granny_Potion_Shop_Map.png", (uint8_t)OoTRegions::Kakariko, false, GameLayout::oot },
    { "Ganon Battle Arena", "", "", (uint8_t)OoTRegions::None, false, GameLayout::oot },
    { "House of Skulltula", "./Resources/OoT/Kakariko/House_Skulltula.png", "./Resources/OoT/Kakariko/House_Skulltula_Map.png", (uint8_t)OoTRegions::Kakariko, false, GameLayout::oot },
    ...
    { "Zora's River", "./Resources/OoT/Zora_River/Zora_River.png", "./Resources/OoT/Zora_River/Zora_River_Map.png", (uint8_t)OoTRegions::Zora_River, true, GameLayout::oot },
    { "Kokiri Forest", "./Resources/OoT/Kokiri_Forest/Kokiri_Forest.png", "./Resources/OoT/Kokiri_Forest/Kokiri_Forest_Map.png", (uint8_t)OoTRegions::Kokiri_Forest, true, GameLayout::oot },
    { "Sacred Forest Meadow", "./Resources/OoT/Sacred_Forest_Meadow/Sacred_Forest_Meadow.png", "./Resources/OoT/Sacred_Forest_Meadow/Sacred_Forest_Meadow_Map.png", (uint8_t)OoTRegions::Sacred_Forest_Meadow, true, GameLayout::oot },
    ...
    { "Zora's Domain", "./Resources/OoT/Zora_Domain/Zora_Domain.png", "./Resources/OoT/Zora_Domain/Zora_Domain_Map.png", (uint8_t)OoTRegions::Zora_Domain, true, GameLayout::oot },
    { "Zora's Fountain", "./Resources/OoT/Zora_Fountain/Zora_Fountain.png", "./Resources/OoT/Zora_Fountain/Zora_Fountain_Map.png", (uint8_t)OoTRegions::Zora_Fountain, true, GameLayout::oot },
    ...
    { "Lost Woods", "./Resources/OoT/Lost_Woods/Lost_Woods.png", "./Resources/OoT/Lost_Woods/Lost_Woods_Map.png", (uint8_t)OoTRegions::Lost_Woods, true, GameLayout::oot },
    { "Desert Colossus", "./Resources/OoT/Desert_Colossus/Desert_Colossus.png", "./Resources/OoT/Desert_Colossus/Desert_Colossus_Map.png", (uint8_t)OoTRegions::Desert_Colossus, true, GameLayout::oot },
    { "Gerudo's Fortress", "./Resources/OoT/Gerudo_Fortress/Fortress.png", "./Resources/OoT/Gerudo_Fortress/Fortress_Map.png", (uint8_t)OoTRegions::Gerudo_Fortress, true, GameLayout::oot },
    { "Haunted Wasteland", "./Resources/OoT/Haunted_Wasteland/Haunted_Wasteland.png", "./Resources/OoT/Haunted_Wasteland/Haunted_Wasteland_Map.png", (uint8_t)OoTRegions::Haunted_Wasteland, false, GameLayout::oot },
    ...
    { "Goron City", "./Resources/OoT/Goron_City/Goron_City.png", "./Resources/OoT/Goron_City/Goron_City_Map.png", (uint8_t)OoTRegions::Goron_City, true, GameLayout::oot },
    { "Lon Lon's Ranch", "./Resources/OoT/Ranch/Lon_Lon_Ranch.png", "./Resources/OoT/Ranch/Lon_Lon_Ranch_Map.png", (uint8_t)OoTRegions::Lon_Lon_Ranch, true, GameLayout::oot },
    ...
    { "Song of Storms Grotto", "./Resources/OoT/Grottos/Open.png", "./Resources/OoT/Grottos/Open_Map.png", (uint8_t)OoTRegions::Kokiri_Forest, false, GameLayout::oot },
    { "Deku Scrubs Grotto", "./Resources/OoT/Grottos/Double_Scrubs.png", "./Resources/OoT/Grottos/Double_Scrubs_Map.png", (uint8_t)OoTRegions::Lost_Woods, false, GameLayout::oot },
    { "Generic Grotto", "./Resources/OoT/Grottos/Open.png", "./Resources/OoT/Grottos/Open_Map.png", (uint8_t)OoTRegions::Lost_Woods, false, GameLayout::oot },
    { "Deku's Theater", "./Resources/OoT/Lost_Woods/Theater.png", "./Resources/OoT/Lost_Woods/Theater_Map.png", (uint8_t)OoTRegions::Lost_Woods, false, GameLayout::oot },
    { "Wolfos Grotto", "./Resources/OoT/Sacred_Forest_Meadow/Wolfos.png", "./Resources/OoT/Sacred_Forest_Meadow/Wolfos_Map.png", (uint8_t)OoTRegions::Sacred_Forest_Meadow, false, GameLayout::oot },
    { "Song of Storms Grotto", "./Resources/OoT/Grottos/Double_Scrubs.png", "./Resources/OoT/Grottos/Double_Scrubs_Map.png", (uint8_t)OoTRegions::Sacred_Forest_Meadow, false, GameLayout::oot },
    { "Redead Grotto", "./Resources/OoT/Kakariko/Redead.png", "./Resources/OoT/Kakariko/Redead_Map.png", (uint8_t)OoTRegions::Kakariko, false, GameLayout::oot },
    { "Open Grotto", "./Resources/OoT/Grottos/Open.png", "./Resources/OoT/Grottos/Open_Map.png", (uint8_t)OoTRegions::Kakariko, false, GameLayout::oot },
    { "Song of Storms Grotto", "./Resources/OoT/Grottos/Open.png", "./Resources/OoT/Grottos/Open_Map.png", (uint8_t)OoTRegions::Death_Mountain_Trail, false, GameLayout::oot },
    { "Cow Grotto", "./Resources/OoT/Grottos/Cow.png", "./Resources/OoT/Grottos/Cow_Map.png", (uint8_t)OoTRegions::Death_Mountain_Trail, false, GameLayout::oot },
    { "Deku Scrubs Grotto", "./Resources/OoT/Grottos/Triple_Scrubs.png", "./Resources/OoT/Grottos/Triple_Scrubs_Map.png", (uint8_t)OoTRegions::Goron_City, false, GameLayout::oot },
    { "Generic Grotto", "./Resources/OoT/Grottos/Open.png", "./Resources/OoT/Grottos/Open_Map.png", (uint8_t)OoTRegions::Death_Mountain_Crater, false, GameLayout::oot },
    { "Deku Scrubs Grotto", "./Resources/OoT/Grottos/Triple_Scrubs.png", "./Resources/OoT/Grottos/Triple_Scrubs_Map.png", (uint8_t)OoTRegions::Death_Mountain_Crater, false, GameLayout::oot },
    { "Song of Storms Grotto", "./Resources/OoT/Grottos/Double_Scrubs.png", "./Resources/OoT/Grottos/Double_Scrubs_Map.png", (uint8_t)OoTRegions::Zora_River, false, GameLayout::oot },
    { "Generic Grotto", "./Resources/OoT/Grottos/Open.png", "./Resources/OoT/Grottos/Open_Map.png", (uint8_t)OoTRegions::Zora_River, false, GameLayout::oot },
    { "Deku Scrubs Grotto", "./Resources/OoT/Grottos/Triple_Scrubs.png", "./Resources/OoT/Grottos/Triple_Scrubs_Map.png", (uint8_t)OoTRegions::Lake_Hylia, false, GameLayout::oot },
    { "Deku Scrubs Grotto", "./Resources/OoT/Grottos/Triple_Scrubs.png", "./Resources/OoT/Grottos/Triple_Scrubs_Map.png", (uint8_t)OoTRegions::Lon_Lon_Ranch, false, GameLayout::oot },
    { "Deku Scrubs Grotto", "./Resources/OoT/Grottos/Cow.png", "./Resources/OoT/Grottos/Cow_Map.png", (uint8_t)OoTRegions::Hyrule, false, GameLayout::oot },
    { "Southeast Grotto", "./Resources/OoT/Grottos/Open.png", "./Resources/OoT/Grottos/Open_Map.png", (uint8_t)OoTRegions::Hyrule, false, GameLayout::oot },
    { "Open Grotto", "./Resources/OoT/Grottos/Open.png", "./Resources/OoT/Grottos/Open_Map.png", (uint8_t)OoTRegions::Hyrule, false, GameLayout::oot },
    { "Market Side Grotto", "./Resources/OoT/Grottos/Open.png", "./Resources/OoT/Grottos/Open_Map.png", (uint8_t)OoTRegions::Hyrule, false, GameLayout::oot },
    { "Tektite Grotto", "./Resources/OoT/Hyrule/Field_Tektite.png", "./Resources/OoT/Hyrule/Field_Tektite_Map.png", (uint8_t)OoTRegions::Hyrule, false, GameLayout::oot },
    { "Kakariko Side Grotto", "./Resources/OoT/Hyrule/Field_Kakariko.png", "./Resources/OoT/Hyrule/Field_Kakariko_Map.png", (uint8_t)OoTRegions::Hyrule, false, GameLayout::oot },
    { "Gerudo Side Grotto", "./Resources/OoT/Hyrule/Field_Gerudo.png", "./Resources/OoT/Hyrule/Field_Gerudo_Map.png", (uint8_t)OoTRegions::Hyrule, false, GameLayout::oot },
    { "Song of Storms Grotto", "./Resources/OoT/Hyrule/Castle_Storms.png", "./Resources/OoT/Hyrule/Castle_Storms_Map.png", (uint8_t)OoTRegions::Castle, false, GameLayout::oot },
    { "Song of Storms Grotto", "./Resources/OoT/Grottos/Double_Scrubs.png", "./Resources/OoT/Grottos/Double_Scrubs_Map.png", (uint8_t)OoTRegions::Gerudo_Valley, false, GameLayout::oot },
    { "Octorok Grotto", "./Resources/OoT/Gerudo_Valley/Octorok.png", "./Resources/OoT/Gerudo_Valley/Octorok_Map.png", (uint8_t)OoTRegions::Gerudo_Valley, false, GameLayout::oot },
    { "Deku Scrubs Grotto", "./Resources/OoT/Grottos/Double_Scrubs.png", "./Resources/OoT/Grottos/Double_Scrubs_Map.png", (uint8_t)OoTRegions::Desert_Colossus, false, GameLayout::oot },
    { "Fairy Fountain", "./Resources/OoT/Fairy/Fountain.png", "./Resources/OoT/Fairy/Fountain_Map.png", (uint8_t)OoTRegions::Sacred_Forest_Meadow, false, GameLayout::oot },
    { "Fairy Fountain", "./Resources/OoT/Fairy/Fountain.png", "./Resources/OoT/Fairy/Fountain_Map.png", (uint8_t)OoTRegions::Zora_River, false, GameLayout::oot },
    { "Fairy Fountain", "./Resources/OoT/Fairy/Fountain.png", "./Resources/OoT/Fairy/Fountain_Map.png", (uint8_t)OoTRegions::Zora_Domain, false, GameLayout::oot },
    { "Fairy Fountain", "./Resources/OoT/Fairy/Fountain.png", "./Resources/OoT/Fairy/Fountain_Map.png", (uint8_t)OoTRegions::Hyrule, false, GameLayout::oot },
    { "Fairy Fountain", "./Resources/OoT/Fairy/Fountain.png", "./Resources/OoT/Fairy/Fountain_Map.png", (uint8_t)OoTRegions::Gerudo_Fortress, false, GameLayout::oot },
    { "Great Fairy Fountain", "./Resources/OoT/Fairy/Great_Fairy.png", "./Resources/OoT/Fairy/Great_Fairy_Map.png", (uint8_t)OoTRegions::Castle, true, GameLayout::oot },
    { "Great Fairy Fountain", "", "./Resources/OoT/Fairy/Great_Fairy_Map.png", (uint8_t)OoTRegions::None, false, GameLayout::oot },
    { "Great Fairy Fountain", "./Resources/OoT/Fairy/Great_Fairy.png", "./Resources/OoT/Fairy/Great_Fairy_Map.png", (uint8_t)OoTRegions::Zora_Fountain, false, GameLayout::oot },
    { "Great Fairy Fountain", "./Resources/OoT/Fairy/Great_Fairy.png", "./Resources/OoT/Fairy/Great_Fairy_Map.png", (uint8_t)OoTRegions::Desert_Colossus, false, GameLayout::oot },
    { "Great Fairy Fountain", "./Resources/OoT/Fairy/Great_Fairy.png", "./Resources/OoT/Fairy/Great_Fairy_Map.png", (uint8_t)OoTRegions::Death_Mountain_Trail, false, GameLayout::oot },
    { "Great Fairy Fountain", "./Resources/OoT/Fairy/Great_Fairy.png", "./Resources/OoT/Fairy/Great_Fairy_Map.png", (uint8_t)OoTRegions::Death_Mountain_Crater, false, GameLayout::oot },
    { "Great Fairy Fountain", "", "", (uint8_t)OoTRegions::None, false, GameLayout::oot },
    { "Bazaar", "./Resources/OoT/Kakariko/Bazaar.png", "./Resources/OoT/Kakariko/Bazaar_Map.png", (uint8_t)OoTRegions::Kakariko, false, GameLayout::oot },
    { "Bazaar", "./Resources/OoT/Market/Bazaar.png", "./Resources/OoT/Market/Bazaar_Map.png", (uint8_t)OoTRegions::Market, false, GameLayout::oot },
    { "Shooting Gallery", "./Resources/OoT/Kakariko/Shooting.png", "./Resources/OoT/Kakariko/Shooting_Map.png", (uint8_t)OoTRegions::Kakariko, false, GameLayout::oot },
    { "Shooting Gallery", "./Resources/OoT/Market/Shooting.png", "./Resources/OoT/Market/Shooting_Map.png", (uint8_t)OoTRegions::Market, false, GameLayout::oot },
    { "Silo", "./Resources/OoT/Ranch/Silo.png", "./Resources/OoT/Ranch/Silo_Map.png", (uint8_t)OoTRegions::Lon_Lon_Ranch, false, GameLayout::oot },
    { "Windmill", "./Resources/OoT/Kakariko/Windmill.png", "./Resources/OoT/Kakariko/Windmill_Map.png", (uint8_t)OoTRegions::Kakariko, true, GameLayout::oot },
    { "Market Entrance", "", "./Resources/OoT/Market/Market_Entrance_Map.png", (uint8_t)OoTRegions::None, false, GameLayout::oot },
    { "Temple of Time Entryway", "", "./Resources/OoT/Market/Temple_of_Time_Entryway_Map.png", (uint8_t)OoTRegions::None, false, GameLayout::oot },
    { "Back Alley", "", "./Resources/OoT/Market/Back_Alley_Map.png", (uint8_t)OoTRegions::None, false, GameLayout::oot },
    { "Warp Songs", "", "./Resources/OoT/Songs/Song_Map.png", (uint8_t)OoTRegions::None, false, GameLayout::oot },
    { "Inside Eggs", "", "", (uint8_t)OoTRegions::None, false, GameLayout::oot },
    { "Market", "", "./Resources/OoT/Hyrule/Market_Map.png", (uint8_t)OoTRegions::None, false, GameLayout::oot }
};
...
SceneMetaInfo MMScenesMetaInfo[MM_NUM_SCENES] =
{
    ...
    { "Lottery", "./Resources/MM/Clock_Town/Lottery.jpg", "", (uint8_t)MMRegions::Clock_Town, false, GameLayout::mm},
    ...
    { "Goron Shop", "./Resources/MM/Goron_Village/Shop.png", "", (uint8_t)MMRegions::Goron_Village, false, GameLayout::mm},
    ...
    { "Zora Shop", "./Resources/MM/Zora_Hall/Zora_Shop.png", "", (uint8_t)MMRegions::Zora_Hall, false, GameLayout::mm},
    { "Evans' Room", "./Resources/MM/Zora_Hall/Evan_Room.png", "", (uint8_t)MMRegions::Zora_Hall, false, GameLayout::mm},
    { "Japas' Room", "", "", (uint8_t)MMRegions::None, false, GameLayout::mm},
    { "Tijo's Room", "", "", (uint8_t)MMRegions::None, false, GameLayout::mm},
    ...
    { "Goron Village", "", "", (uint8_t)MMRegions::None, false, GameLayout::mm},
    { "Spring Water Cave", "", "", (uint8_t)MMRegions::None, false, GameLayout::mm}
};
