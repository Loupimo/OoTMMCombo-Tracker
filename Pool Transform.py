...
def parse_file(input_file, output_file, arrayname, prefix):
    ...
    with open(input_file, 'r') as infile, open(output_file, 'w') as outfile:
        ...
        for i, row in filereader.iterrows():
            ...
            objectstr = objectstr + "\t{ " + idstr + ", " + scenestr + ", \"" + str(row["location"]) + "\", ObjectType::" + str(row["type"]) + " }"
...
#input_file = 'D:\Emulation\OoTMMCombo-Tracker\pool_mm.csv'
#output_file = 'D:\Emulation\OoTMMCombo-Tracker\pool_mm.txt'
...
#
#input_file = 'D:\Emulation\OoTMMCombo-Tracker\pool_oot.csv'
#output_file = 'D:\Emulation\OoTMMCombo-Tracker\pool_oot.txt'
